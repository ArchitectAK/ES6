...
- [Generators](generators/index.html) - Generators are a new type of function that allow us to pause functions in the middle of execution, to be resumed later. We hit pause within our function by using the new yield keyword. And this can be used multiple times within the same function. So generators make it much easier to create asynchronous functions.
